...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Angular User Album is a web application that allows users to log in, view user albums, and manage their profiles. In Addition to Admin Roles (Add User, Edit User, Delete User), Form Validation, and Error Page.",
  },
  {
    id: 2,
    ...
    description:
      "This project is an implementation of the popular game using Reactjs. Test your strategic skills by playing against a friend. In this game, two players take turns marking the spaces in a three-by-three grid with X or O. The player who succeeds in placing three of their marks in a horizontal, vertical, or diagonal row is the winner. If XPlayer is drawn with Oplayer, there will be the last round to determine the winner.",
  },
  {
    id: 3,
